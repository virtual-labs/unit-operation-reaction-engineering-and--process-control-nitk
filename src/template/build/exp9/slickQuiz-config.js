...
var quizJSON = {
    ...
    "questions": [
       ...
       { // Question 3 - Multiple Choice, Multiple True Answers, Select All
            ...
            "incorrect": "<p><span>wrong</span> It's wrong,Ans:		τ = θ for an isothermal tubular reactor in which the density of the process fluid is constant</p>" // no comma here
        },
        { // Question 4
            ...
            "a": [
              ...
              {"option": "V/6 lit",   "correct": false} // no comma here
            ],
            "correct": "<p><span>Right answer</span> Ans:V/2 lit</p>",
            "incorrect": "<p><span>wrong</span> It's wrong,<br>Ans:V/2 lit</p>"  // no comma here
        },
        { // Question 5
