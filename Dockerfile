...
RUN mkdir /unit-operation-reaction-engineering-and--process-control-nitk

COPY src/ /unit-operation-reaction-engineering-and--process-control-nitk/src

WORKDIR ./unit-operation-reaction-engineering-and--process-control-nitk/src
